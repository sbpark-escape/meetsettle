...
- Give feedback on code, documentation, and ideas without personal attacks.
- Welcome newcomers and explain project context when possible.
...
For now, report concerns through GitHub issues only when they are safe to discuss publicly. Private reporting contact details will be added as the project matures.
